"""AAA AI Runtime worker entry point."""
...
ALIASES = {
    ...
    "vulva": {"vulva", "vagina", "pussy", "female_genitalia", "female_genital", "female_genitals"},
    "anus": {"anus", "buttocks_anus", "anal"},
    "testicles": {"testicle", "testicles", "scrotum"},
    "x_ray": {"x_ray", "xray"},
    "cross_section": {"cross_section", "crosssection"},
}
